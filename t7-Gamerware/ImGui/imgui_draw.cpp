...
void ImGui::StyleColorsDefault(ImGuiStyle* dst)
{
    ...
    //Gamer9882's ImGui style plz dont steal it
    ...
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.0784313753247261f, 0.0784313753247261f, 0.0784313753247261f, 0.9399999976158142f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.0784313753247261f, 0.0784313753247261f, 0.0784313753247261f, 0.9399999976158142f);
    colors[ImGuiCol_TitleBg] = ImVec4(0.98f, 0.26f, 0.26f, 0.50f);
    colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.98f, 0.26f, 0.26f, 0.50f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.98f, 0.26f, 0.26f, 0.50f);
    ...
    //colums color
    colors[ImGuiCol_Header] = ImVec4(0.0f, 0.0f, 0.0f, 0.5411764979362488f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.98f, 0.26f, 0.26f, 0.50f);
  ...
  // colors[ImGuiCol_MenuBarBg]              = ImVec4(0.10f, 0.10f, 0.10f, 0.66f);
   ...
   // colors[ImGuiCol_ButtonHovered]          = ImVec4(1.00f, 0.00f, 0.20f, 0.80f);
...
//    colors[ImGuiCol_TabHovered]             = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
 //   colors[ImGuiCol_TabActive]              = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
...
ImFont* ImFontAtlas::AddFontDefault(const float size_pixels, const ImFontConfig* font_cfg_template)
{
